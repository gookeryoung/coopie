# iter-06 需求：README 与项目文档完善

## 需求来源

用户要求：
1. 结合本项目作为 copier 模板的特点，完善 README
2. 补充 template/README.md 第 5-9 行（badge 区）对应信息
3. 同步完善项目文档

## 需求确认

- Badge 范围：两者都做（项目根 README 加 badge + 模板 README 补充更多 badge）
